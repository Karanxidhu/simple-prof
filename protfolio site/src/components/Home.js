            ...
            <div className="w-full sm:w-[67%] lg:w-[50%] min-h-[100vh] mx-auto">
                ...
                <div className="w-full min-h-[100vh] bg-[#282828] p-3">
                    ...
                    <div>
                        ...
                        <img alt="gif"className='pt-5' src="https://github.com/Anmol-Baranwal/Cool-GIFs-For-GitHub/assets/74038190/0c7eb6ed-663b-4ce4-bfbd-18239a38ba1b"></img>
                        <div className="pt-10">
                        ...
                        <p className='text-center p-1 text-sm sm:text-base md:text-2xl font-bold text-[#7cafc2] hover:text-[#5f8b9c]'> <Link to="mailto:KaranXidhu@proton.me">KaranXidhu@proton.me</Link></p>
